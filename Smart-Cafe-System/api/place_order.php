...
try {
    ...
    $insertOrder = $pdo->prepare("INSERT INTO orders (table_number, total_price, estimated_wait_minutes) VALUES (?, ?, ?)");
    $insertOrder->execute([$tableNumber, $totalPrice, $estimatedWait]);
